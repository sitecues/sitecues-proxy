...
class FriendlyServer extends Server {
    ...
    constructor(options) {
        ...
        const perCallDefault = {
                  ...
                  loaderSiteID      : process.env.SITECUE_LOADER_SITE_ID || process.env.LOADER_SITE_ID || process.env.SITE_ID
              ...
              safeDefault = {
                  ...
                  siteId      : perCallDefault.loaderSiteID || staticDefault.loaderSiteID
              };
        ...
        if (options.loaderSiteID && typeof options.loaderSiteID === 'string') {
            options.loaderSiteID = options.loaderSiteID.trim().toLowerCase();
            if(!options.loaderSiteID) {
                options.loaderSiteID = safeDefault.loaderSiteID;
            }
        }
        else {
            options.loaderSiteID = safeDefault.loaderSiteID;
