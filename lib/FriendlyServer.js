    ...
    constructor(options) {
        ...
        const
            perCallDefault = {
                ...
                scheme      : process.env.SITECUES_PROXY_SCHEME       || process.env.PROXY_SCHEME       || process.env.SCHEME,
                ...
                loaderFile  : process.env.SITECUES_PROXY_LOADER_FILE  || process.env.PROXY_LOADER_FILE  || process.env.LOADER_FILE,
                loaderStrategy : process.env.SITECUES_PROXY_LOADER_STRATEGY || process.env.PROXY_LOADER_STRATEGY || process.env.LOADER_STRATEGY
            },
