...
class Server {
    constructor(options) {
        ...
        function onLog(event) {
            ...
            console.log('hoxy is logging...');
            console.log('arguments.length:');
            console.log(arguments.length);
            console.log('this:');
            console.log(this);
            console.log('event own props:');
            ...
            console.log(event.stack);
            console.log('event.error own props:');
            //console.log(Object.getOwnPropertyNames(event.error));
            ...
            // let message = event.message.substring(0, errTypeIndex);
        ...
        // Handler for redirects. In reverse mode, redirects need to be modified
        // to use proxy URLs.
        if (state.reverseMode) {
            proxy.intercept(
                {
