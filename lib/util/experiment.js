//
// This module contains unstable, experimental utilities for use by the sitecues proxy.
// It exists to show ideas and help during refactoring.
...
function getBetterLoadScript(config) {
    ...
    result = '' +
        ...
        '                sitecues.config.scriptUrl=document.location.protocol+'                   +
                             '\'//js.dev.sitecues.com/l/s;id=\'+sitecues.config.siteId+'          +
