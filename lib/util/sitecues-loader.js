...
function format(options) {
    ...
    if (dangit.isExtendableType(config.scriptUrl)) {
        ...
        // to other systems that need to work with our URLs.slksdo
    ...
    keys.sort(function (a, b) {
        // NOTE: This code makes no attempt to be case-insensitive.
        //       Currently doesn't matter, but prone to breakage.
        if (a === 'siteId') {
            return -1;
        }
        else if (b === 'siteId') {
