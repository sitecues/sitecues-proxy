...
function createLoader(options) {
    ...
    //get a loader that contains the sitecuesBadge data
    var createdSitecuesLoader = sitecuesLoader.format(options);
    //return the loader that contains sitecues badge.
