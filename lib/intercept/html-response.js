    ...
    return (request, response) => {
        ...
        if (state.reverseMode) {
            ...
            $('base[href]').first().attr('href', (index, value) => {
                ...
                return state.proxyLinks ?
                    server.toProxiedPath(absoluteUrl) :
                    absoluteUrl;
            });
            ...
            const proxiedBaseUrl = server.toProxiedPath(targetBaseUrl);
            ...
            if (state.proxyLinks) {
                ...
                $('a[href]').attr('href', (index, value) => {
                    ...
                    if (isAbsolute(value) && isHttpish(value)) {
                        ...
                        return server.toProxiedPath(value);
                    }
                    else if (isSchemeRelative(value) || isOriginRelative(value)) {
                        return server.toProxiedPath(
